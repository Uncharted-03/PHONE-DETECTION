...
# Copyright (c) 2024 Uncharted-03 || Uday
# All rights reserved.
# ============================================================
...
print("================================================")
print("📵 Made by Uncharted-03 || Uday")
print("================================================")
...
while True:
    ...
    if phone_detected:
        for (x1, y1, x2, y2) in boxes_to_draw:
            ...
            cv2.putText(frame, "PHONE NICHHEE RAKHHHH!", (x1, y1 - 10), 
    ...
    # Add copyright text overlay at bottom of frame
    cv2.putText(frame, "Made by Uncharted-03 || Uday", (10, frame.shape[0] - 20), 
